...
class TreasureHuntPuzzleTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->tm = $this->sm->get('treasurehunt_treasurehuntpuzzle_mapper');
    ...
    public function testFindById()
    {
        ...
        $treasurehuntpuzzle->setTitle('title');
        $treasurehuntpuzzle->setIdentifier('identifier');
    ...
    public function testFindAll()
    {
        ...
        $treasurehuntpuzzle = new TreasureHuntPuzzleEntity();
        $treasurehuntpuzzle->setDomain('domain 2');
        $treasurehuntpuzzle->setTitle('title2');
        $treasurehuntpuzzle->setIdentifier('identifier2');
        $treasurehuntpuzzle = $this->tm->insert($treasurehuntpuzzle);
        $treasurehuntpuzzle = new TreasureHuntPuzzleEntity();
        $treasurehuntpuzzle->setDomain('domain 3');
        $treasurehuntpuzzle->setTitle('title3');
        $treasurehuntpuzzle->setIdentifier('identifier3');
        $treasurehuntpuzzle = $this->tm->insert($treasurehuntpuzzle);
